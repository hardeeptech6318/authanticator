...
function Home() {
      ...
      <div className="w-full flex flex-col lg:flex-row">
        ...
        <div className="hidden w-full lg:flex justify-between max-lg:bg-white py-5 max-lg:mt-1 max-lg:px-4 max-lg:shadow-lg max-lg:shadow-gray-200 max-lg:h-auto max-lg:overflow-auto transition-all duration-500 delay-200 " id="navbar">
          ...
          >
            ...
            <Link className="bg-indigo-50 text-indigo-600 rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 py-3 px-6 text-sm hover:bg-indigo-100" to="/login">Login</Link>
            <Link
            to="/signup"
  ...
  <section
    className="pt-8 lg:pt-32 bg-[url('https://pagedone.io/asset/uploads/1691055810.png')] h-full bg-center bg-cover"
  >
    <div className="mx-auto max-w-7xl h-full flex justify-center items-center flex-col px-4 sm:px-6 lg:px-8 relative text-center">
      <div
